...
let darkPuble:Color = Color(red: 48/255, green: 25/255, blue: 52/255, opacity: 1.0)

let navigationBarItemsColor:Color = darkPuble
let backgroundColor:Color         = Color.white
let screenTitle:String            = "Home"
let firstSectionTitle:String      = "Ads"
let secondSectionTitle:String     = "Brands"
let cartImg:String                = "cart"
let favouriteImg:String           = "heart.fill"
let searchImg:String              = "magnifyingglass"
let titleColor:Color              = darkPuble
    ...
    var body: some View {
        ...
        ZStack { //start of: ZStack
            ...
            ScrollView {
                VStack{
                    Divider()
                    HeaderView(title: firstSectionTitle, color: titleColor)
                    HeaderView(title: secondSectionTitle, color: titleColor)
            ...
            .toolbar { //start of: toolbar
                ToolbarItem(placement: .topBarTrailing, content: {
                    HStack {
                        ButtonView(imageSystemName: cartImg
                                  , itemCounter: 10)
                        ButtonView(imageSystemName: favouriteImg
                                  , itemCounter: 2)
                    }
                })
                ToolbarItem(placement: .topBarLeading, content: {
                    ButtonView(imageSystemName: searchImg
                               , itemCounter: 0)
                })
            }//end of: toolbar
    }
...
let dummyImgsUrlArray = ["https://cdn.logojoy.com/wp-content/uploads/2018/05/30143356/127.png",
...
let dummyBrndsNamesArray = ["Adidas","Hermes","Ralph Aura","H&M","Zara","Hollister","Burberry"]
