...
struct PaymentView: View {
    ...
    var body: some View {
                    ...
                    Text(
                        String(
                            ...
                            (Double(
                                ...
                                * (CurrencyManager.currentCurrencyRate.value
                                    ?? 1.0))
        ...
        .onAppear {
            ...
            viewModel.promoCode =
                AuthManager.shared.applicationUser?.couponCode ?? ""
            viewModel.setUp(
                totalPrice: Double(
                    AuthManager.shared.applicationUser?.cart?.cost?.totalAmount?
                        .formattedPrice ?? "0.0") ?? 0.0)
        }
