...
struct ProductInfoView: View {
    ...
    var listOfImages : [String] = [
        "https://cdn.shopify.com/s/files/1/0906/4257/9827/files/product_9_image1.jpg?v=1738825478",
        "https://cdn.shopify.com/s/files/1/0906/4257/9827/files/product_10_image1.jpg?v=1738825481",
        "https://cdn.shopify.com/s/files/1/0906/4257/9827/files/product_9_image3.jpg?v=1738825478"
    ]
    var body: some View {
        ZStack {
            Color(.white)
            ...
            VStack {
                ScrollView(.horizontal, showsIndicators: false) {
                    VStack {
                        LazyHStack {
                            ForEach(Array(listOfImages.enumerated()), id: \.offset) {
                                index, discount in
                                CustomNetworkImageView(
                                    url: URL(
                                        string: listOfImages[index]
