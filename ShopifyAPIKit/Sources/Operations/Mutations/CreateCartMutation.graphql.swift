...
public class CreateCartMutation: GraphQLMutation {
  ...
  public init(
    ...
    lines: GraphQLNullable<[CartLineInput]>
  ) {
    self.email = email
  ...
  public struct Data: ShopifyAPIKit.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("cartCreate", CartCreate?.self, arguments: ["input": [
        "buyerIdentity": [
      ...
      public struct Cart: ShopifyAPIKit.SelectionSet {
        ...
        public struct Lines: ShopifyAPIKit.SelectionSet {
          ...
          public struct Node: ShopifyAPIKit.SelectionSet {
            ...
            /// CartCreate.Cart.Lines.Node.Merchandise
            ///
            ...
            public struct Merchandise: ShopifyAPIKit.SelectionSet {
              ...
              /// CartCreate.Cart.Lines.Node.Merchandise.AsProductVariant
              ///
              ...
              public struct AsProductVariant: ShopifyAPIKit.InlineFragment {
                ...
                public typealias RootEntityType = CreateCartMutation.Data.CartCreate.Cart.Lines.Node.Merchandise
                ...
                /// CartCreate.Cart.Lines.Node.Merchandise.AsProductVariant.Image
                ///
                /// Parent Type: `Image`
                ...
                /// CartCreate.Cart.Lines.Node.Merchandise.AsProductVariant.Price
                ///
                /// Parent Type: `MoneyV2`
                ...
                /// CartCreate.Cart.Lines.Node.Merchandise.AsProductVariant.PriceV2
                ///
                /// Parent Type: `MoneyV2`
                ...
                /// CartCreate.Cart.Lines.Node.Merchandise.AsProductVariant.QuantityRule
                ///
                ...
                /// CartCreate.Cart.Lines.Node.Merchandise.AsProductVariant.Product
                ///
                /// Parent Type: `Product`
            ...
            /// CartCreate.Cart.Lines.Node.Cost
            ///
            ...
            public struct Cost: ShopifyAPIKit.SelectionSet {
              ...
              /// CartCreate.Cart.Lines.Node.Cost.TotalAmount
              ///
              /// Parent Type: `MoneyV2`
              ...
              /// CartCreate.Cart.Lines.Node.Cost.SubtotalAmount
              ///
              /// Parent Type: `MoneyV2`
              ...
              /// CartCreate.Cart.Lines.Node.Cost.AmountPerQuantity
              ///
              /// Parent Type: `MoneyV2`
        ...
        public struct Cost: ShopifyAPIKit.SelectionSet {
          ...
          /// CartCreate.Cart.Cost.CheckoutChargeAmount
          ///
          /// Parent Type: `MoneyV2`
          ...
          /// CartCreate.Cart.Cost.TotalDutyAmount
          ///
          /// Parent Type: `MoneyV2`
