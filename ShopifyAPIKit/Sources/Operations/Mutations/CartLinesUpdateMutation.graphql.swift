...
public class CartLinesUpdateMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation CartLinesUpdate($cartId: ID!, $lines: [CartLineUpdateInput!]!) { cartLinesUpdate(cartId: $cartId, lines: $lines) { __typename cart { __typename id checkoutUrl note totalQuantity lines(first: 50) { __typename nodes { __typename id merchandise { __typename ... on ProductVariant { id title } } quantity cost { __typename amountPerQuantity { __typename amount currencyCode } totalAmount { __typename amount currencyCode } subtotalAmount { __typename amount currencyCode } } } } } userErrors { __typename code field message } } }"#
    ))
