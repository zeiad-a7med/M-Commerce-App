...
public class CartLinesUpdateMutation: GraphQLMutation {
  ...
  public struct Data: ShopifyAPIKit.SelectionSet {
    ...
    public struct CartLinesUpdate: ShopifyAPIKit.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { ShopifyAPIKit.Objects.CartLinesUpdatePayload }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      public struct Cart: ShopifyAPIKit.SelectionSet {
        ...
        public struct Lines: ShopifyAPIKit.SelectionSet {
          ...
          /// CartLinesUpdate.Cart.Lines.Node
          ///
          ...
          public struct Node: ShopifyAPIKit.SelectionSet {
            ...
            /// CartLinesUpdate.Cart.Lines.Node.Merchandise
            ///
            ...
            public struct Merchandise: ShopifyAPIKit.SelectionSet {
              ...
              /// CartLinesUpdate.Cart.Lines.Node.Merchandise.AsProductVariant
              ///
              ...
              public struct AsProductVariant: ShopifyAPIKit.InlineFragment {
                ...
                public typealias RootEntityType = CartLinesUpdateMutation.Data.CartLinesUpdate.Cart.Lines.Node.Merchandise
                ...
                /// CartLinesUpdate.Cart.Lines.Node.Merchandise.AsProductVariant.Image
                ///
                /// Parent Type: `Image`
                ...
                /// CartLinesUpdate.Cart.Lines.Node.Merchandise.AsProductVariant.Price
                ///
                /// Parent Type: `MoneyV2`
                ...
                /// CartLinesUpdate.Cart.Lines.Node.Merchandise.AsProductVariant.PriceV2
                ///
                /// Parent Type: `MoneyV2`
                ...
                /// CartLinesUpdate.Cart.Lines.Node.Merchandise.AsProductVariant.QuantityRule
                ///
                ...
                /// CartLinesUpdate.Cart.Lines.Node.Merchandise.AsProductVariant.Product
                ///
                /// Parent Type: `Product`
            ...
            /// CartLinesUpdate.Cart.Lines.Node.Cost
            ///
            ...
            public struct Cost: ShopifyAPIKit.SelectionSet {
              ...
              /// CartLinesUpdate.Cart.Lines.Node.Cost.TotalAmount
              ///
              /// Parent Type: `MoneyV2`
              ...
              /// CartLinesUpdate.Cart.Lines.Node.Cost.SubtotalAmount
              ///
              /// Parent Type: `MoneyV2`
              ...
              /// CartLinesUpdate.Cart.Lines.Node.Cost.AmountPerQuantity
              ///
              /// Parent Type: `MoneyV2`
        ...
        public struct Cost: ShopifyAPIKit.SelectionSet {
          ...
          /// CartLinesUpdate.Cart.Cost.CheckoutChargeAmount
          ///
          /// Parent Type: `MoneyV2`
          ...
          /// CartLinesUpdate.Cart.Cost.TotalDutyAmount
          ///
          /// Parent Type: `MoneyV2`
          ...
          /// CartLinesUpdate.Cart.Cost.TotalTaxAmount
          ///
          /// Parent Type: `MoneyV2`
